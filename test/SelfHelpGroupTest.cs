...
public class SelfHelpGroupTest
{
    ...
    public async Task SelfHelpGroupIndex_SearchForSelfHelpGroup_ClientNoFoundResults()
    {
        ...
        var result = await sut.Index("GeengroepGevonden123", null);
    ...
    [Fact]
    public async Task SelfHelpGroupIndex_SearchForSelfHelpGroup_OrthopedagogueFoundResults()
    {
        var context = ManagerContainer.GetWDPRContext();
        ...
        var sut = new SelfHelpGroupController(null, context, mockUserManager.Object, chatManager);
        sut.ControllerContext = controllerContext;
        var action = await sut.Index("Voet", AgeCategory.Middelste);
    ...
    [Fact]
    public async Task SelfHelpGroupIndex_SearchForSelfHelpGroup_OrthopedagogueNoFoundResults()
    {
        var context = ManagerContainer.GetWDPRContext();
