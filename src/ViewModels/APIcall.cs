namespace src.Controllers
{
    public static class APIcall
    {
        ...
        public static async Task<String> GetClientFile(string birthDate, int bsn, IConfiguration configuration)
        {
            ...
            string encryptedData = await SigningData.EncryptData(dateTime, configuration);
